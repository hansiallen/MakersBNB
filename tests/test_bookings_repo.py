...
def test_remove_booking(db_connection):
    ...
    booking = Booking(None, 1, 2, date(2024, 11, 12), date(2024, 11, 14))
    booking_id = booking_repo.add_booking(booking)
...
def test_list_bookings(db_connection):
    ...
    booking_repo.add_booking(Booking(None, 1, 2, date(2024, 11, 12), date(2024, 11, 14)))
    booking_repo.add_booking(Booking(None, 1, 3, date(2024, 11, 15), date(2024, 11, 18)))
